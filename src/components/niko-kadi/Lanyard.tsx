...
// Types for the voter data passed to the 3D scene
interface VoterData {
    firstName: string;
    surname: string;
    county: string;
...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false }) {
    ...
    // Assets placed in public/niko-kadi/
    const { nodes, materials } = useGLTF('/niko-kadi/card.glb') as any;
    const texture = useTexture('/niko-kadi/lanyard.png');
