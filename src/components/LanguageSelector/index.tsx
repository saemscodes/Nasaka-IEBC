...
const LanguageSelector: React.FC = () => {
  ...
  const getButtonPositions = () => {
    ...
    const centerX = 0; // Relative to main button
    const centerY = 0; // Relative to main button
    
    const radius = 20; // 20px max radius as requested
    const buttonSize = 24; // Smaller floating buttons
          ...
          <div className="floating-buttons-container">
            ...
            {hasOverflow && (
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                onClick={() => console.log('Show all languages modal')}
              >
