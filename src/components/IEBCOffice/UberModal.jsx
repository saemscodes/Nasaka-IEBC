...
const MotorcycleIcon = ({ className }) => (
  <svg viewBox="0 0 511.99 511.99" className={className} xmlns="http://www.w3.org/2000/svg">
    <path style={{ fill: 'currentColor' }} d="M95.998,242.668c-1.461,0-2.914-0.312-4.273-0.906l-42.671-18.657c-3.883-1.703-6.391-5.531-6.391-9.781v-28.796c0-5.891,4.781-10.672,10.672-10.672s10.664,4.781,10.664,10.672l71.483,23.952c5.625-1.75,11.609,1.375,13.367,7c1.75,5.625-1.383,11.609-7,13.359l-42.671,13.344C98.139,242.496,97.068,242.668,95.998,242.668z" />
    <path style={{ fill: 'currentColor' }} d="M353.993,175.997c-1.094,0-68.186,10.5-69.264,10.156c-5.609-1.812-8.703-7.812-6.891-13.422c6.25-19.452,20.905-35.812,42.342-47.312c15.688-8.422,29.641-11.359,30.219-11.484c5.781-1.188,11.422,2.531,12.625,8.297C364.212,127.998,358.493,175.997,353.993,175.997z" />
    <path style={{ fill: '#E6E9ED' }} d="M148.481,317.446c-0.312,0-0.617,0-0.93-0.031c-5.875-0.516-10.218-5.672-9.71-11.545l5.765-66.796c0.508-5.859,5.672-10.203,11.547-9.703c5.867,0.5,10.21,5.672,9.703,11.547l-5.765,66.78C158.614,313.259,153.958,317.446,148.481,317.446z" />
    <path fill="currentColor" d="M95.998,242.668c-1.461,0-2.914-0.312-4.273-0.906l-42.671-18.657c-3.883-1.703-6.391-5.531-6.391-9.781v-28.796c0-5.891,4.781-10.672,10.672-10.672s10.664,4.781,10.664,10.672l71.483,23.952c5.625-1.75,11.609,1.375,13.367,7c1.75,5.625-1.383,11.609-7,13.359l-42.671,13.344C98.139,242.496,97.068,242.668,95.998,242.668z" />
    <path fill="currentColor" d="M353.993,175.997c-1.094,0-68.186,10.5-69.264,10.156c-5.609-1.812-8.703-7.812-6.891-13.422c6.25-19.452,20.905-35.812,42.342-47.312c15.688-8.422,29.641-11.359,30.219-11.484c5.781-1.188,11.422,2.531,12.625,8.297C364.212,127.998,358.493,175.997,353.993,175.997z" />
    <path fill="#E6E9ED" d="M148.481,317.446c-0.312,0-0.617,0-0.93-0.031c-5.875-0.516-10.218-5.672-9.71-11.545l5.765-66.796c0.508-5.859,5.672-10.203,11.547-9.703c5.867,0.5,10.21,5.672,9.703,11.547l-5.765,66.78C158.614,313.259,153.958,317.446,148.481,317.446z" />
    <path fill="currentColor" d="M85.334,261.323C38.28,261.323,0,299.604,0,346.665c0,47.047,38.28,85.326,85.334,85.326c47.046,0,85.326-38.279,85.326-85.326C170.661,299.604,132.38,261.323,85.334,261.323z" />
    <path fill="currentColor" d="M426.647,261.323c-47.029,0-85.311,38.281-85.311,85.342c0,47.047,38.281,85.326,85.311,85.326c47.062,0,85.343-38.279,85.343-85.326C511.99,299.604,473.71,261.323,426.647,261.323z" />
    <path fill="#CCD1D9" d="M85.334,309.321c-20.586,0-37.335,16.75-37.335,37.344c0,20.578,16.75,37.328,37.335,37.328s37.327-16.75,37.327-37.328C122.662,326.071,105.92,309.321,85.334,309.321z" />
    <path fill="#CCD1D9" d="M426.647,309.321c-20.577,0-37.311,16.75-37.311,37.344c0,20.578,16.733,37.328,37.311,37.328c20.594,0,37.344-16.75,37.344-37.328C463.991,326.071,447.241,309.321,426.647,309.321z" />
    <path fill="#E6E9ED" d="M85.342,357.321c-3.539,0-7-1.75-9.031-4.969c-3.141-4.984-1.656-11.562,3.328-14.719l101.326-63.998c4.984-3.141,11.57-1.656,14.718,3.328c3.141,4.984,1.656,11.578-3.328,14.719L91.029,355.681C89.256,356.79,87.287,357.321,85.342,357.321z" />
  </svg>
);

const CarIcon = ({ className }) => (
  <svg viewBox="0 0 512 512" className={className} xmlns="http://www.w3.org/2000/svg">
    <path fill="currentColor" d="M466.963,233.298c-0.194-0.647-0.26-1.295-0.455-1.942c-5.633-22.539-19.234-43.007-38.406-59.652c-19.82-17.294-45.727-30.507-75.197-37.761c-16.774-4.209-34.715-6.476-53.369-6.476c-18.652,0-36.594,2.268-53.369,6.476c-38.018,9.392-70.08,28.628-90.871,53.757c-10.881,13.084-18.652,27.786-22.668,43.396h-3.238c-4.34,0-151.428,11.464-126.559,119.822h68.59c-0.064-1.167-0.129-2.332-0.129-3.497c0-3.433,0.324-6.866,0.842-9.845c4.793-27.073,28.238-46.763,55.766-46.763s50.973,19.69,55.701,46.568c0.584,3.173,0.906,6.606,0.906,10.04c0,1.049-0.059,2.098-0.115,3.149c-0.012,0.032-0.004,0.078-0.014,0.11h0.008c-0.004,0.08-0.004,0.159-0.008,0.238h144.045c-0.064-1.167-0.129-2.332-0.129-3.497c0-3.433,0.324-6.866,0.842-9.845c4.793-27.073,28.24-46.763,55.766-46.763c27.527,0,50.972,19.69,55.701,46.503c0.584,3.238,0.906,6.672,0.906,10.105c0,1.045-0.058,2.09-0.115,3.137c-0.01,0.035-0.002,0.087-0.014,0.122h0.01c-0.006,0.08-0.006,0.159-0.01,0.238h56.719c7.629,0,13.816-6.203,13.844-13.831C512.213,263.339,513.328,250.078,466.963,233.298z M159.73,231.02c3.305-9.364,8.41-18.277,15.449-26.739c17.553-21.179,44.949-37.242,77.203-45.208c15.156-3.758,30.961-5.699,47.152-5.699c13.303,0,26.304,1.353,38.883,3.949c0.89,0.199,1.797,0.346,2.684,0.56l-29.778,73.213H196.498L159.73,231.02z M339.34,231.009l26.844-65.911c17.162,6.41,32.449,15.22,44.883,26.1c13.154,11.399,22.516,24.574,27.691,38.49c0.168,0.471,0.367,0.936,0.524,1.408h-73.037L339.34,231.009z" />
    <path fill="currentColor" d="M127.898,310.244c-18.328,0-33.551,13.278-36.594,30.7c-0.389,2.073-0.584,4.274-0.584,6.477c0,1.165,0.064,2.33,0.195,3.497c1.748,18.847,17.617,33.615,36.982,33.615s35.234-14.768,36.984-33.615c0.129-1.167,0.193-2.332,0.193-3.497c0-2.203-0.193-4.404-0.582-6.477C161.449,323.521,146.228,310.244,127.898,310.244z" />
    <path fill="currentColor" d="M384.9,310.244c-18.33,0-33.551,13.278-36.594,30.7c-0.388,2.073-0.584,4.274-0.584,6.477c0,1.165,0.066,2.33,0.196,3.497c1.748,18.847,17.617,33.615,36.982,33.615c19.365,0,35.234-14.768,36.984-33.615c0.129-1.167,0.193-2.332,0.193-3.497c0-2.203-0.193-4.404-0.582-6.477C418.451,323.521,403.23,310.244,384.9,310.244z" />
  </svg>
);

const LimousineIcon = ({ className }) => (
  <svg viewBox="0 -43.14 122.88 122.88" className={className} xmlns="http://www.w3.org/2000/svg">
...
const VanIcon = ({ className }) => (
  <svg viewBox="0 -26.28 122.88 122.88" className={className} xmlns="http://www.w3.org/2000/svg">
...
const HappyIcon = ({ className }) => (
  <svg viewBox="0 0 254.3 256" className={className} xmlns="http://www.w3.org/2000/svg">
    <path fill="currentColor" d="M140.4,18.6c-12.2,0-22.1,9.9-22.1,22.1s9.9,22.1,22.1,22.1s22.1-9.9,22.1-22.1S152.6,18.6,140.4,18.6z M225.4,56.3 l-69.2,42.3L147.3,206c-0.5,7.1-6.5,12.6-13.6,12.6c-0.3,0-0.6,0-0.9,0l-43-2.7c-2.7-0.2-5.2-1.1-7.3-2.7l23.5-23.6l15.1,0.9 l1.5-21.4h-7.4l-38.4,38.6c-2.7,2.6-6.1,4-9.6,4c-3.4,0-6.8-1.3-9.5-3.8l-30.4-29.4c-5.4-5.2-5.5-13.8-0.3-19.2 c5.2-5.4,13.8-5.5,19.2-0.3L67.1,179l25.7-25.8l6.7-70L53,20.8c-3.9-5.2-2.8-12.6,2.4-16.4c5.2-3.9,12.6-2.8,16.4,2.4l42.7,57.2 l36.9,10l61.7-37.7c5.5-3.4,12.8-1.6,16.2,3.9C232.7,45.7,230.9,52.9,225.4,56.3z M92.2,226.4h7.9v19.7h-7.9V226.4z M76.5,226.4h7.9 V254h-7.9V226.4z M60.7,226.4h7.9v19.7h-7.9V226.4z" />
  </svg>
);

const UberLogo = ({ className }) => (
  <svg viewBox="0 0 926.906 321.777" className={className} xmlns="http://www.w3.org/2000/svg">
