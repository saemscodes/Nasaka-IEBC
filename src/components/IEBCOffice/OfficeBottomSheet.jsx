            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className={`text-sm mt-1 line-clamp-1 transition-colors duration-300 ${
                  theme === 'dark' ? 'text-ios-gray-300' : 'text-muted-foreground'
                }`}>
              ...
              {distanceToOffice && (
                <div className="ml-4 text-right">
                  <span className={`text-sm font-medium transition-colors duration-300 ${
                    theme === 'dark' ? 'text-ios-blue-400' : 'text-primary'
                  }`}>
                    {distanceToOffice.toFixed(1)} km
                  </span>
                  {currentRoute && currentRoute[0] && (
                    <p className={`text-xs mt-1 transition-colors duration-300 ${
                      theme === 'dark' ? 'text-ios-gray-400' : 'text-muted-foreground'
                    }`}>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className={`border-b pb-4 transition-colors duration-300 ${
                  theme === 'dark' ? 'border-ios-gray-600' : 'border-border'
                }`}>
                ...
                <div className="space-y-3">
                  {office.constituency_name && (
                    <div className="flex items-start">
                      <svg className={`w-5 h-5 mt-0.5 mr-3 flex-shrink-0 transition-colors duration-300 ${
                        theme === 'dark' ? 'text-ios-gray-400' : 'text-gray-400'
                      ...
                      <div>
                        <p className={`text-sm font-medium transition-colors duration-300 ${
                          theme === 'dark' ? 'text-ios-gray-200' : 'text-gray-900'
                        }`}>Constituency</p>
                        <p className={`text-sm transition-colors duration-300 ${
                          theme === 'dark' ? 'text-ios-gray-300' : 'text-gray-600'
                        }`}>{office.constituency_name}</p>
                      </div>
                    </div>
                  )}
                  ...
                  {office.phone && (
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href={`tel:${office.phone}`} className={`text-sm hover:underline transition-colors duration-300 ${
                          theme === 'dark' ? 'text-ios-blue-300' : 'text-blue-600'
                        }`}>
                          {office.phone}
                        </a>
                      </div>
                  ...
                  {office.email && (
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href={`mailto:${office.email}`} className={`text-sm hover:underline transition-colors duration-300 ${
                          theme === 'dark' ? 'text-ios-blue-300' : 'text-blue-600'
                        }`}>
                          {office.email}
                        </a>
                ...
                {distanceToOffice && (
                  <div className={`rounded-xl p-4 border transition-colors duration-300 ${
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <p className={`text-sm font-medium transition-colors duration-300 ${
                          theme === 'dark' ? 'text-ios-gray-200' : 'text-foreground'
                        }`}>Distance from you</p>
                ...
                {routingError && (
                  <div className={`rounded-xl p-4 border transition-colors duration-300 ${
                    theme === 'dark'
                      ? 'bg-ios-red/20 border-ios-red/30'
                      : 'bg-destructive/10 border-destructive/20'
                  }`}>
                    <div className="flex items-start">
                      <svg className={`w-5 h-5 mt-0.5 mr-3 flex-shrink-0 transition-colors duration-300 ${
                        theme === 'dark' ? 'text-ios-red-400' : 'text-destructive'
                      }`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        ...
                        <p className={`text-xs mt-1 transition-colors duration-300 ${
                          theme === 'dark' ? 'text-ios-gray-300' : 'text-muted-foreground'
                        }`}>Use Google Maps for directions instead.</p>
                      </div>
                    </div>
                  </div>
                )}
                ...
                <div className="space-y-3 pt-2">
                  <button
                    ...
                    className={`w-full font-semibold py-4 px-6 rounded-2xl flex items-center justify-center space-x-2 transition-all active:scale-95 shadow-lg duration-300 ${
                      theme === 'dark'
                        ? 'bg-ios-blue-600 hover:bg-ios-blue-700 text-white'
                ...
                {office.operating_hours && (
                  <div className={`rounded-xl p-4 border transition-colors duration-300 ${
                    theme === 'dark'
                      ? 'bg-ios-gray-800 border-ios-gray-600'
