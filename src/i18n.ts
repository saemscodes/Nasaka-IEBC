  ...
  en: {
    nasaka: {
      ...
      office: {
        ...
        verified: "Verified",
        addressVerifying: "Address information being verified by community",
        communityPhoto: "Community Photo",
        voterRegTitle: "More About Voter Registration",
        voterRegTapDetails: "Tap for Continuous Voter Registration (CVR) details",
        voterRegistrationDesc: "Continuous Voter Registration (CVR) is available at this office",
        voterRegDetailsSub: "During official IEBC registration windows. Outside active periods, limited services (transfers & updates) are still offered.",
        requiredDocuments: "Required Documents",
        docID: "Original National ID Card",
        docIDSub: "Mandatory for new registration and most services",
        docPassport: "Valid Kenyan Passport",
        docPassportSub: "Accepted alternative to National ID",
        servicesAvailable: "Services Available Here",
        serviceNewReg: "New Voter Registration",
        serviceNewRegSub: "Biometric capture and issuance of voter’s card (during active CVR periods)",
        serviceTransfer: "Transfer of Polling Station",
        serviceTransferSub: "Change your assigned polling station within or across constituencies",
        serviceUpdate: "Update of Particulars",
        serviceUpdateSub: "Name, ID number correction, contact details, or disability status",
        serviceReplacement: "Lost Voter’s Card Replacement",
        serviceReplacementSub: "Replacement of defaced or lost voter’s card",
        pollingStationComingSoon: "Digital Polling Station registry is coming soon. Use this office for physical assistance.",
        address: "Address",
        office: "IEBC Office",
        ...
        recently: "Recently",
        nearbyIn: "Nearby in {{county}}",
        wardsIn: "Wards in {{office}}",
        pollingStationsIn: "Polling Stations in {{ward}}",
        pollingStationRegistryComingSoon: "Digital Polling Station registry is coming soon.",
        confirmVerifying: "Verification of 40,000+ locations is in progress by the community."
      },
      intelligence: {
        title: "Live Intelligence",
        score: "Score",
        tapToCheck: "Tap to check visit difficulty & AI reasoning"
      },
      bottomSheet: {
